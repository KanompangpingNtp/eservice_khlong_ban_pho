...
<body>
    ...
    <div class="box_text_border">
        ...
        <div>
            ...
            <span class="dotted-line" style="width: 37%; text-align:center;"> data </span>
        ...
        <div>
            <span>เลขประจำตัวประชาชน</span><span class="dotted-line" style="width: 33%; text-align:center;"> data
            </span>
            <span>โทรศัพท์</span><span class="dotted-line" style="width: 41%; text-align:center;"> data </span>
        </div>
        <div>
            <span>ที่อยู่</span><span class="dotted-line" style="width: 96%; text-align:center;"> data </span>
        </div>
    </div>
    ...
    <div class="box_text" style=" margin-left:7px; margin-top:2px;">
        <div style="text-align:left">
            ...
            <span><input type="checkbox"> อื่นๆ</span><span class="dotted-line" style="width: 28%; text-align: center;">
                data
            </span>
        </div>
    </div>
    ...
    <div class="box_text" style="text-align:left; margin-left:8px; line-height: 12px; margin-top: 5px;">
        ...
        <div style="width: 100%;">
            <span style="float: left; width: 60%; line-height: 0.9;"><input type="checkbox" style="margin: 0;">
                บัตรประจำตัวประชาชน หรือบัตรอื่นที่ออกโดยหน่วยงานของรัฐที่มีรูปถ่าย</span>
            <span style="float: right; width: 40%; line-height: 0.9;"><input type="checkbox" style="margin: 0;">
                ทะเบียนบ้าน
            </span>
            <div style="clear: both;"></div>
            ...
            <span style="float: left; width: 100%; line-height: 0.9;"><input type="checkbox" style="margin: 0;">
                ...
                (ในกรณีผู้ขอรับเงินเบี้ยยังชีพผู้สูงอายุประสงค์ขอรับเงินเบี้ยยังชีพผู้สูงอายุผ่านธนาคาร)</span>
            <div style="clear: both;"></div>
            <span style="float: left; width: 100%; line-height: 0.9;"><input type="checkbox" style="margin: 0;">
    ...
    <div class="box_text_border"
        ...
        <div style="border-bottom:2px solid black;">
            <div id="left" style="float: left; width: 49%; ">
                ...
                <span class="dotted-line" style="width: 80%; text-align: center; margin-top: 10px;"> data </span>
                <span style="margin-left:10px;">แล้ว</span>
                <div class="box_text" style="text-align:left; margin-top: 10px;">
                    <div style="width: 100%;">
                        <span style="width: 100%; "><input type="checkbox"> เป็นผู้มีคุณสมบัติ <span
                                style="border-bottom: 2px solid black;">ในการยืนยันสิทธิ</span>ครบถ้วน</span>
                        <span style="width: 100%; "><input type="checkbox"> เป็นผู้ที่ <span
                                style="border-bottom: 2px solid black;">รอตรวจสอบคุณสมบัติ</span> ณ
                            วันที่มีสิทธิได้รับ</span>
                        <span style="width: 100%; margin-left: 7px;">เงินเบี้ยยังชีพ</span>
            ...
            <div id="right"
                ...
                <div class="box_text" style="text-align:left; margin-top: 10px;">
                    <div style="width: 100%;">
                        ...
                        <span style="width: 100%; "><input type="checkbox"> ไม่สมควรรับยืนยันสิทธิ</span>
                        <span class="dotted-line" style="width: 100%; text-align: center; margin-top: 10px;"> data
                        </span>
                    </div>
                </div>
    ...
    <div class="box_text">
        <span>และตามช่วงระยะเวลาในการยืนยันสิทธิ ภายในวันที่ 10 ของทุกเดือน โดยได้รับตั้งแต่เดือน</span><span
            class="dotted-line" style="width: 32%; text-align: center;"> data
        </span>
    </div>
    <div class="box_text">
        <span>พ.ศ.</span><span class="dotted-line" style="width: 19%; text-align: center;">
            data
        </span><span> กรณีผู้สูงอายุย้ายภูมิลำเนา
