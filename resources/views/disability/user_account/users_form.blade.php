...
<div class="container">
    <h2 class="text-center">แบบคำขอลงทะเบียนรับเงินเบี้ยความพิการ</h2><br>
    <form action="{{ route('DisabilityFormCreate') }}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            <input type="radio" id="trade_condition_option1" name="trade_condition" value="option1" required>
            <label for="trade_condition_option1">บิดา - มารดา</label>
        </div>
        <div>
            <input type="radio" id="trade_condition_option2" name="trade_condition" value="option2">
            <label for="trade_condition_option2"> บุตร</label>
        </div>
        <div>
            <input type="radio" id="trade_condition_option3" name="trade_condition" value="option3">
            <label for="trade_condition_option3">สามี - ภรรยา</label>
        </div>
        <div>
            <input type="radio" id="trade_condition_option4" name="trade_condition" value="option4">
            <label for="trade_condition_option4"> พี่น้อง</label>
        </div>
        <div>
            <input type="radio" id="trade_condition_option5" name="trade_condition" value="option5">
        ...
        <div>
            <input type="radio" id="type_of_disability_option1" name="type_of_disability" value="option1" required>
