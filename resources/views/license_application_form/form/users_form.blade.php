        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" name="food_distribution_type" id="food_distribution_type"
                        class="form-control">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="food_distribution_area">โดยมีพื้นที่ประกอบการ</label>
                    <div style="display: flex; align-items: center;">
                        <input type="text" name="food_distribution_area" id="food_distribution_area"
                            class="form-control" style="flex: 1; margin-right: 5px;">
                        <span>ตารางเมตร</span>
                    </div>
                </div>
            ...
            <div class="form-group">
                <input type="checkbox" name="collection_service_business" id="collection_service_business"
                    value="yes">
            ...
            <div class="row ms-3">
                ...
                <div class="col-md-3 mb-3">
                    <input type="text" name="waste_collection_detail" id="waste_collection_detail"
                        class="form-control">
                </div>
            </div>
            ...
            <div class="row ms-3">
                <div class="col-md-3 mb-3" style="margin-top: 10px;">
                    <input type="checkbox" name="collect_and_dispose_waste" id="collect_and_dispose_waste"
                        value="yes">
            ...
            <div class="row ms-3">
                ...
                <div class="col-md-3 mb-3">
                    <input type="text" name="garbage_collection_detail" id="garbage_collection_detail"
                        class="form-control">
                </div>
            </div>
            ...
            <div class="row ms-3">
                <div class="col-md-3 mb-3" style="margin-top: 10px;">
                    <input type="checkbox" name="collect_and_dispose_of_waste" id="collect_and_dispose_of_waste"
                        value="yes">
                    <label for="collect_and_dispose_of_waste">เก็บขนและกำจัดมูลฝอย โดยมีแหล่งกำจัดที่</label>
                </div>
                <div class="col-md-3 mb-3">
                    <input type="text" name="collect_and_dispose_of_waste_detail"
                        id="collect_and_dispose_of_waste_detail" class="form-control">
                </div>
            </div>
