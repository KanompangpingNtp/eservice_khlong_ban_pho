...
<form action="{{ route('BusinessDocFormCreate') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option8" name="group_of_websites[]" value="option8">
            <label class="form-check-label" for="option8">ออกแบบตกแต่งอาคารและสถานที่</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option9" name="group_of_websites[]" value="option9">
            <label class="form-check-label" for="option9">การศึกษา</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option10" name="group_of_websites[]" value="option10">
            <label class="form-check-label" for="option10">การเงิน กฎหมาย บัญชี และให้คำาปรึกษาอื่นๆ</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option11" name="group_of_websites[]" value="option11">
            <label class="form-check-label" for="option11">ยานยนต์และอะไหล่</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option12" name="group_of_websites[]" value="option12">
            <label class="form-check-label" for="option12">เครื่องมือสื่อสาร/กล้อง</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option13" name="group_of_websites[]" value="option13">
            <label class="form-check-label" for="option13">แฟชั่น/เครื่องแต่งกาย/เครื่องประดับ</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option14" name="group_of_websites[]" value="option14">
            <label class="form-check-label" for="option14">อาหารและเครื่องดื่ม</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option15" name="group_of_websites[]" value="option15">
            <label class="form-check-label" for="option15">ศิลปะและวัฒนธรรม</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option16" name="group_of_websites[]" value="option16">
            <label class="form-check-label" for="option16">บริการให้เช่าอุปกรณ์ เครื่องมือ และเครื่องยนต</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option17" name="group_of_websites[]" value="option17">
            <label class="form-check-label" for="option17">เครื่องอุปโภค/บริโภคประจำาวัน</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option18" name="group_of_websites[]" value="option18">
            <label class="form-check-label" for="option18">ข่าว/สื่อ/โฆษณา</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option19" name="group_of_websites[]" value="option19">
            <label class="form-check-label" for="option19">เฟอร์นิเจอร์และอุปกรณ์ตกแต่ง</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option20" name="group_of_websites[]" value="option20">
            <label class="form-check-label" for="option20">อุปกรณ์กีฬา/สันทนาการ</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option21" name="group_of_websites[]" value="option21">
            <label class="form-check-label" for="option21">วัสดุก่อสร้าง/เครื่องมือ/อุปกรณ์ก่อสร้าง</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option22" name="group_of_websites[]" value="option22">
    ...
    <div class="form-group">
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option1" name="types_of_business[]" value="option1">
            <label class="form-check-label" for="option1">ขายปลีกสินค้า สินค้าทุกอย่างที่คุณต้องการ</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option2" name="types_of_business[]" value="option2">
            <label class="form-check-label" for="option2">บริการ สินค้าทุกอย่างที่คุณต้องการ</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option3" name="types_of_business[]" value="option3">
            <label class="form-check-label" for="option3">บริการ สินค้าทุกอย่างที่คุณต้องการ</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option4" name="types_of_business[]" value="option4">
            <label class="form-check-label" for="option4">บริการอินเทอร์เน็ต (Internet Service Provider : ISP)</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option5" name="types_of_business[]" value="option5">
            <label class="form-check-label" for="option5">ให้เช่าพื้นที่ของเครื่องคอมพิวเตอร์แม่ข่าย (Web Hosting)</label>
        </div>
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="option6" name="types_of_business[]" value="option6">
    ...
    <div class="form-group">
        ...
        <div class="form-check">
            ...
            <input type="text" class="form-control" id="order_products_used_detail" name="order_products_used_detail" placeholder="เมื่อเลือก อื่นๆ โปรดระบุ สินค้าทุกอย่างที่คุณต้องการ">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="form-check">
            ...
            <input type="text" class="form-control" id="payment_method_detail" name="payment_method_detail" placeholder="เมื่อเลือก อื่นๆ โปรดระบุ จ่ายเงินสดกับเจ้าของร้าน">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="form-check">
            ...
            <input type="text" class="form-control" id="shipping_method_detail" name="shipping_method_detail" placeholder="เมื่อเลือก อื่นๆ โปรดระบุ ที่ร้านมีบริการส่งเอง">
        </div>
    </div>
