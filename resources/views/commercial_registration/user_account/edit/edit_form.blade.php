...
<a href="{{route('TableTradeRegistryUsersPages')}}" class="btn btn-primary">กลับ</a>
...
<form action="{{ route('TradeRegistryUserFormUpdate', $form->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="date" name="receive_day" id="receive_day" class="form-control" value="{{ old('receive_day', $form->receive_day) }}" required>
    </div>

    <div class="mb-3">
        <label for="written_at" class="form-label">เขียนที่</label>
        <input type="text" name="written_at" id="written_at" class="form-control" value="{{ old('written_at', $form->written_at) }}" required>
    </div>

    <div class="mb-3">
        <label for="write_the_date" class="form-label">เขียนวันที่</label>
        <input type="text" name="write_the_date" id="write_the_date" class="form-control" value="{{ old('write_the_date', $form->write_the_date) }}" required>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="full_name" id="full_name" class="form-control" value="{{ old('full_name', $form->full_name) }}" required>
    </div>

    <div class="mb-3">
        <label for="ethnicity" class="form-label">เชื้อชาติ</label>
        <input type="text" name="ethnicity" id="ethnicity" class="form-control" value="{{ old('ethnicity', $form->ethnicity) }}">
    </div>

    <div class="mb-3">
        <label for="nationality" class="form-label">สัญชาติ</label>
        <input type="text" name="nationality" id="nationality" class="form-control" value="{{ old('nationality', $form->nationality) }}">
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="name_used_to_call" id="name_used_to_call" class="form-control" value="{{ old('name_used_to_call', $form->name_used_to_call) }}">
    </div>

    <div class="mb-3">
        <label for="registered" class="form-label">ได้จดทะเบียนพาณิชย์คําขอที่</label>
        <input type="text" name="registered" id="registered" class="form-control" value="{{ old('registered', $form->registered) }}">
    </div>

    <div class="mb-3">
        <label for="registration" class="form-label">ทะเบียนที่</label>
        <input type="text" name="registration" id="registration" class="form-control" value="{{ old('registration', $form->registration) }}">
    </div>
