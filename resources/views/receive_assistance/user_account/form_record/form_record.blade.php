...
@section('user_content')
    ...
    <div class="container">
        <h3 class="text-center">แบบคำขอรับเงินสงเคราะห์ <br>
            ...
            <tbody class="text-center">
                @foreach ($forms as $form)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('ReceiveAssistanceUsersShowFormEdit', $form->id) }}"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <a href="{{ route('ReceiveAssistanceUserExportPDF', $form->id) }}" class="btn btn-danger btn-sm"
                                target="_blank">
