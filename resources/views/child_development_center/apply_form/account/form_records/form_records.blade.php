    ...
    <table class="table table-bordered table-striped" id="data_table">
        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('ChildApplyUserShowFormEdit', $form->id) }}" class="btn btn-warning btn-sm text-white" style="font-size:21px; padding-top:5px; padding-bottom:5px;"><i class="bi bi-pencil-square"></i></a>
