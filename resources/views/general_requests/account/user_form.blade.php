        ...
        <form action="{{ route('FormCreate') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="salutation" name="salutation">
                    ...
                    <option value="นาย"
                        {{ old('salutation', $user->userDetails->salutation ?? '') == 'นาย' ? 'selected' : '' }}>นาย
                    </option>
                    <option value="นาง"
                        {{ old('salutation', $user->userDetails->salutation ?? '') == 'นาง' ? 'selected' : '' }}>นาง
                    </option>
                    <option value="นางสาว"
                        {{ old('salutation', $user->userDetails->salutation ?? '') == 'นางสาว' ? 'selected' : '' }}>นางสาว
                    </option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="age" name="age"
                    value="{{ old('age', $user->userDetails->age ?? '') }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="house_number" name="house_number" maxlength="50"
                    value="{{ old('house_number', $user->userDetails->house_number ?? '') }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="village" name="village" maxlength="100"
                    value="{{ old('village', $user->userDetails->village ?? '') }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="subdistrict" name="subdistrict" maxlength="100"
                    value="{{ old('subdistrict', $user->userDetails->subdistrict ?? '') }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="district" name="district" maxlength="100"
                    value="{{ old('district', $user->userDetails->district ?? '') }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="province" name="province" maxlength="100"
                    value="{{ old('province', $user->userDetails->province ?? '') }}">
            </div>
