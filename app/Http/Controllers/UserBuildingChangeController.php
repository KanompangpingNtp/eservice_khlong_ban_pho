...
class UserBuildingChangeController extends Controller
{
    //
    public function BuildingChangeFormPage()
    {
        return view('building_modification.form.users_form');
    }
    ...
    public function BuildingChangeUserFormPage()
    {
        ...
        return view('building_modification.user_account.user_form', compact('user'));
    }
    ...
    public function BuildingChangeUsersPages()
    {
        ...
        return view('building_modification.user_account.form_record.form_record', compact('forms'));
    }
    ...
    public function BuildingChangeUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('building_modification.user_account.export_pdf.export_pdf', compact('form'))
    ...
    public function BuildingChangeShowFormEdit($id)
    {
        $form = BuildingChange::with('buildingChangeFiles')->findOrFail($id);

        return view('building_modification.user_account.edit.edit_form', compact('form'));
    }

    public function BuildingChangeUserFormUpdate(Request $request, $id)
    {
        $request->validate([
            'written_at' => 'nullable|string',
            'full_name' => 'nullable|string',
        ...
        $buildingChange = BuildingChange::findOrFail($id);
        ...
        if ($request->has('delete_attachments')) {
            foreach ($request->delete_attachments as $attachmentId) {
                $attachment = BuildingChangeFile::find($attachmentId);
                if ($attachment) {
